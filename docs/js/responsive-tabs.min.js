    ...
    RESPONSIVEUI.responsiveTabs = function() {
        ...
        if (!$tabSets.hasClass("responsive-tabs--enabled")) {
            ...
            $tabSets.each(function() {
                ...
                var $activePanel = $tabs.find(
                    ".responsive-tabs__panel--active"
                );
                if (!$activePanel.length) {
                    $activePanel = $tabs
                        .find(".responsive-tabs__panel")
                        .first()
                        .addClass("responsive-tabs__panel--active");
                }
                $tabs
                    .find(".responsive-tabs__panel")
                    .not(".responsive-tabs__panel--active")
                    .hide()
                    .attr("aria-hidden", "true");
                $activePanel.attr("aria-hidden", "false");
                $activePanel.addClass(
                ...
                $tabs.find(".responsive-tabs__heading").each(function() {
                    ...
                    var $tabListItem = $("<li/>", {
                        ...
                        "aria-controls":
                            "tablist" + tablistcount + "-panel" + tabcount,
                        role: "tab",
                        tabindex: 0,
